...
public class BookingUserAdapter extends RecyclerView.Adapter<BookingUserAdapter.ViewHolder> {
    ...
    private final List<BookingUser> bookings;
    private final Context context;
    private final FragmentManager fragmentManager;

    public BookingUserAdapter(List<BookingUser> bookings, Context context, FragmentManager fragmentManager) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        BookingUser booking = bookings.get(position);
        holder.tvGuideName.setText("Name: " + booking.getUserName());
